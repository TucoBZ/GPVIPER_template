...
final class ___VARIABLE_VIPERName:identifier___Router: ___VARIABLE_VIPERName:identifier___RouterProtocol {
    ...
    static func present___VARIABLE_VIPERName:identifier___Module() -> UIViewController? {
        ...
        let view: ___VARIABLE_VIPERName:identifier___ViewProtocol = LoginView()
        let presenter: ___VARIABLE_VIPERName:identifier___PresenterProtocol & ___VARIABLE_VIPERName:identifier___InteractorOutputProtocol = ___VARIABLE_VIPERName:identifier___Presenter()
        ...
        let localDataManager: ___VARIABLE_VIPERName:identifier___DataManagerInputProtocol = ___VARIABLE_VIPERName:identifier___LocalDataManager()
